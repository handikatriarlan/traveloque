...
class PackageBookingController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.package-bookings.index', compact('package_bookings'));
    }
    ...
    {
        return view('admin.package-bookings.show', compact('packageBooking'));
    }
    ...
    public function update(Request $request, PackageBooking $packageBooking)
    {
        ...
        return redirect()->route('admin.package-bookings.show', $packageBooking);
    }
